  ...
  return (
    <div className='mt-12'>
          ...
          {earningData.map((item)=> (
            ...
            >
              ...
              <p className='mt-3'>
                ...
                text-green-600 ml-2`}>{item.percentage}</span>
              </p>
            </div>
          ))}
        </div>
      ...
      justify-center'>
        <div className='bg-white 
        dark:text-gray-200
        dark:bg-screen-dark-bg m-3 p-4
          ...
          gap-10 flex-wrap text-justify'>
            ...
            border-color m-4 pr-10'>
              <div>
                ...
                <p
                className='text-gray-500 mt-1'>Budget</p>
              </div>
              <div>
                <p>
                ...
                <p
                className='text-gray-500 mt-1'>Expense</p>
              </div>
              <div className='mt-5'>
                <SparkLine 
