...
const Cart = () => {
    ...
    const totalPrice = productCartItem.reduce((acc, current)=> acc + parseInt(current.total), 0)

    const totalQty = productCartItem.reduce((acc, current)=> acc + parseInt(current.qty), 0)
